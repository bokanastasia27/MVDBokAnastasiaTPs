...
ggplot(
  ...
  labs(
    ...
    y = "Densidad",
    fill = "Ingreso",
    title = "Distribución de horas trabajadas según ingreso, por sexo",
    subtitle = "Comparación de la distribución de horas trabajadas para cada nivel de income, faceteada por sexo"
  ) +
  theme_minimal()
```

Este grafico demuestra que la mayor concentración de observaciones tanto para hombres como para mujeres ronda las 40 horas semanales, y para ambos se observa que las observaciones asociadas con un ingreso más alto tienden a superar las 40 horas semanales. Se observan diferencias poco significativas en las horas según género, por lo tanto esta interacción no resulta valiosa de explorar.
